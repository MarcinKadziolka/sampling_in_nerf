...
def render_rays(ray_batch,
    ...
    ### generating points from the normal distribution
    ...
    mu_expanded = mu.expand(-1, N_samples)
    sigma_expanded = sigma.expand(-1, N_samples)
    z_vals = torch.normal(mu_expanded, sigma_expanded)
    ###
